...
uint16_t colorFromTouch(uint16_t x, uint16_t y) {
  ...
  // Stretch a simple RGB field across the whole touchscreen.
  // X adds red, Y adds green, and blue fades toward the
  // opposite corner. No HSV conversion or lookup table needed.
...
void setup() {
  ...
  Serial.println("Rainbow Touch Draw ready");
}
