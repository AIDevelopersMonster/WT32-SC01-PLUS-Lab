...
static constexpr int LCD_TE  = 48;
...
// Factory-recovered RS485 mapping; physical Arduino validation pending.
...
// Physically validated external input channels on the reference specimen.
